...
### interne_hendelser
Structs for all events types in internal event log for Arbeidssoekerregisteret. Also includes serialization and deserialization support. The internal eventlog is a kafka topic using Json and 64 bit int as Key.

###  pdl_graphql
Autogenerated structs for the PDL domain (based on graphql schema)

### regler_core
Core crate for rules governing who can register as arbeidssøkere.

### regler_inngang
Actual rules.

### regler_macro
Macros supporting rules.
