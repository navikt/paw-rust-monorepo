...
use texas_client::token_client::ReqwestTokenClient;
...
async fn main() -> Result<()> {
    ...
    let token_client_config =
        toml::from_str::<TokenClientConfig>(read_config_file!("token_client_config.toml"))?;
    let token_client = Arc::new(ReqwestTokenClient::from_config(
        token_client_config,
